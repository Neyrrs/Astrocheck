...
const SearchPack = (props) => {
  ...
  return (
    <div className={`flex px-2 text-lg py-2 gap-2 border-1 h-fit ${focus ? "border-[#6384E9]" : "border-gray-300"} rounded-xl shadow-sm hover:border-[#6384E9] bg-white w-full focus:border-[#6384E9] ease-in-out duration-300 items-center`}>
      <Search />
