...
const FormAbsence = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast("success", "Absen berhasil dikirim!", () => {});
  ...
  return (
    <div className="bg-[#f9f9f9] rounded-xl w-[40rem] shadow-2xl py-10 mt-5 h-fit">
      <div className="px-10 pb-10 text-center border-b-2 border-gray-300">
      ...
      <div className="my-10 px-24">
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <TextArea
            ...
            onChange={handleChange}
            disabled={formData.reason !== "Lainnya" && formData.reason !== ""}
          />
