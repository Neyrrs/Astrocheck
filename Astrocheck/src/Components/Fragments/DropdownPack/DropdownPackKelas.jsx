...
const DropdownPackKelas = (props) => {
  return (
    <div>
      ...
      <select
        name={props.name}
        className={`font-normal outline-none border-gray-300 hover:shadow-md duration-200 ease-in-out text-black border-[2px] px-2 mb-2 py-[0.5rem] rounded-md text-sm w-full`}
        value={props.value || ""}
