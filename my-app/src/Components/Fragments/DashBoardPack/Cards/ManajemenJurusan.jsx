...
// TODO sesuaikan state loadingnya saat ganti page di isi dari tablenya. Contoh ingin pindah page 1, itu datanya diload lagi otomatis kalo lagi load itu nanti tulisannya/isi dari datanya "loading" dulu baru muncul data baru. Jangan data lamanya masih ditampilin
// TODO buat validasi button disable ketika lagi send request ke database, agar user tidak klik berkali kali
// TODO Tembak data siswa baru
// TODO Buat filter ini buat fiturnya di akhir akhir aja

// ! untuk client side itu tidak perlu menggunakan fetch hook yang globalnya, karena dia akan fetch ke semuanya. cukup admin saja
